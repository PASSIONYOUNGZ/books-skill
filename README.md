...
![books skill](E:\Codex\book\codex-book-skill\books skill.png)

## 典型案例

案例：《我们为什么要睡觉》（EPUB 单本整理）。

- 原始输入：本地 EPUB 原书，约 5.6 MB，正文抽取约 241002 字符。原书EPUB[我们为什么要睡觉 ](<examples/why-we-sleep/我们为什么要睡觉 ([英] 马修·沃克).epub>)。

- **一句话指令：对文件夹下面，《我们为什么要睡觉》使用book.skill进行整理**

- **整理版参考：[Markdown](examples/why-we-sleep/summary.md) / [EPUB](examples/why-we-sleep/summary.epub)**

  ![image-20260510113407435](C:\Users\86137\AppData\Roaming\Typora\typora-user-images\image-20260510113407435.png)

  ![image-20260510113437561](C:\Users\86137\AppData\Roaming\Typora\typora-user-images\image-20260510113437561.png)

- 质量记录：[自检](examples/why-we-sleep/self-check.md) / [内容审计](examples/why-we-sleep/quality-audit.json) / [输出审计](examples/why-we-sleep/output-audit.json)
...
- 结果：Markdown `10839` 字符，内容质量审计 `0` 红旗、`0` 警告，输出结构审计 `all_ok: true`

完整案例说明见 [examples/why-we-sleep/README.md](examples/why-we-sleep/README.md)。
